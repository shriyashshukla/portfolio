        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="relative">
            <div className="block md:hidden">
              <Image
                src="/images/company-mobile.png"
                width={700}
                height={700}
                alt="Luxabord Mobile View"
                className="w-full h-auto transition-transform duration-500 transform hover:scale-105"
              />
            </div>
            <div className="hidden md:block">
              <Image
                src="/images/company-laptop.png"
                width={700}
                height={700}
                alt="Luxabord Laptop View"
                className="w-full h-auto transition-transform duration-500 transform hover:scale-105"
              />
            </div>
          </div>
          <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
            <a href="https://luxabord.com/">
              <h1
                className={`text-4xl font-bold text-white mb-4 cursor-pointer transition-transform duration-500 ${
            ...
            <p className="text-base lg:text-lg">
              ...
              elegance with contemporary fashion trends, ensuring our customers
            ...
            <p className="text-base lg:text-lg mt-4">
              ...
              anime-inspired designs to add a unique flair to our collection,
              merging the world of fashion with popular anime culture to create
              standout pieces.
            </p>
              ...
              {tab === "about" && (
                <div>
                  ...
                  <p className="text-base lg:text-lg">
                    ...
                    fashion, collaborating with designers to create unique
                    anime-themed prints and patterns.
                  </p>
                </div>
              )}

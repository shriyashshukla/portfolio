    ...
    <>
      ...
      >
        ...
        <div className="z-10">
          ...
          <div className="card">
            <a className="social-link1" href="https://www.instagram.com/shriyash_shukla/">
              <svg
                style={{ color: "white" }}
            ...
            <a className="social-link2" href="https://github.com/shriyashshukla">
              <svg
                viewBox="0 0 496 512"
                height="1em"
                fill="#fff"
            ...
            <a className="social-link3" href="https://discord.gg/9rtQnrSJTE">
              <svg
                style={{ color: "white" }}
                xmlns="http://www.w3.org/2000/svg"
                width={16}
            ...
            <a className="social-link4" href="https://www.linkedin.com/in/shriyash-shukla-49a426220/">
              <svg
                fill="#fff"
                viewBox="0 0 448 512"
                height="1em"
          ...
          {emailSubmitted ? (
            ...
            <form className="flex flex-col" onSubmit={handleSubmit}>
              ...
              <button
                ...
                class="border text-gray-50  duration-300 relative group cursor-pointer   overflow-hidden h-16 w-48 rounded-md bg-neutral-800 p-2  font-extrabold hover:bg-sky-700 mx-auto">
                ...
                <p class="z-10 absolute bottom-2 left-2">Submit</p>
              </button>
